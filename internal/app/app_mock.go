...
//			},
//			GetConnectedThingsFunc: func(ctx context.Context, deviceID string) ([]Thing, error) {
...
func (mock *ThingsAppMock) AddMeasurement(ctx context.Context, t Thing, m Measurement) error {
...
func (mock *ThingsAppMock) GetConnectedThings(ctx context.Context, deviceID string) ([]Thing, error) {
